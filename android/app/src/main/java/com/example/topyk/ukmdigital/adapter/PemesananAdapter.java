...
/**
 * Created by topyk on 7/19/2017.
 */

public class PemesananAdapter extends BaseAdapter {
    private ArrayList<Pemesanan> data_penjualan = new ArrayList<Pemesanan>();
    Context context;
    private static LayoutInflater inflater = null;

    public PemesananAdapter(Context context, ArrayList<Pemesanan> data_penjualan){
...
//            TextView alamat = (TextView)vi.findViewById(R.id.alamat);
            TextView nama_barang = (TextView)vi.findViewById(R.id.nama_barang); //jadi id_trans
            TextView nomor = (TextView)vi.findViewById(R.id.no_transaksi);
            TextView nama_pembeli = (TextView)vi.findViewById(R.id.nama_pembeli); //jadi waktu


            Pemesanan daftar_transaksi = data_penjualan.get(position);
